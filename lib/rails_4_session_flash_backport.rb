...
when 4
  warn "You're on Rails 4 so it's probably safe to remove the rails_4_session_flash_backport gem!"
else
  warn "rails_4_session_flash_backport doesnt yet do anything on Rails #{Rails.version}"
end
